import { MaterialPalette } from './src/MaterialColors.types'
import MaterialColorsModule from './src/MaterialColorsModule'
import { MaterialColors } from '@type/theme'
import { useEffect, useState } from 'react'
import { AppState } from 'react-native'

export * from './src/MaterialColors.types'
...
function paletteToColors(palette: MaterialPalette | null) {
  if (!palette) {
    return null
  }
...
export function useDynamicColors(): {
  ...
  return paletteToColors(materialYou)
}
