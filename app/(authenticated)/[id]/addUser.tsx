...
function Form() {
  ...
  function handlePress() {
    ...
    findUserIdByEmail(email).then((id) => {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      <TextInput placeholder='E-mail' value={email} onChangeText={setEmail} style={{ padding: 8, borderWidth: 1, borderColor: 'black', margin: 4, borderRadius: 8 }} />
