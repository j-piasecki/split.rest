...
const logger = new Logger('CompleteSplitEntry')
...
export async function completeSplitEntry(
  ...
  try {
    ...
    logger.log({ msg: 'Split entry completed', splitId: args.splitId, groupId: args.groupId, callerId, userId: args.userId, change: targetUserChange })
